...
This study aims to address these gaps by developing a linear model to analyze the impact of a nation’s status, healthcare factors, and economic indicators on life expectancy. The response variable is Life Expectancy, while the predictors include Status (Developed vs. Developing), Diphtheria Immunization Coverage, Government Total Expenditure, Numbers of Doctors and Nurses per 10000, and Schooling. The analysis seeks to quantify the influence of these variables, providing insights into the disparities in life expectancy and identifying factors that contribute to these differences.
...
&\ \beta_3 \text{Health Expenditure} + \beta_4 \text{Number of Doctors per 10000} + \\
&\ \beta_5 \text{Number of Nurses per 10000} + \\
&\ \beta_6 \text{Health Expenditure} \times \text{Number of Doctors per 10000} \times \text{Number of Nurses per 10000} + \epsilon_i
\end{align*}

\begin{align*} 
\text{LifeExpectancy}_{\text{developing}} = &\ \beta_0 + \beta_1 \text{Diphtheria Immunization} + \beta_2 \text{Schooling} + \\
&\ \beta_3 \text{Health Expenditure} + \beta_4 \text{Number of Doctors per 10000} + \\
&\ \beta_5 \text{Number of Nurses per 10000} + \\
&\ \beta_6 \text{Health Expenditure} \times \text{Number of Doctors per 10000} \times \text{Number of Nurses per 10000} + \epsilon_i
\end{align*}
