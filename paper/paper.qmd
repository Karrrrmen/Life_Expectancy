...
#| tbl-cap: "Summary of key model estimates for Developed and Developing counties, including coefficients for predictors like Diphtheria, Schooling, and Percentage of HealthExpenditure, pct_doctor, pct_nursing, with standard errors for each estimate. Model performance statistics, such as sample size, R², and adjusted R², are also displayed."
#| echo: false
#| eval: true
#| warning: false
#| message: false
